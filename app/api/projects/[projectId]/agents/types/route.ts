...
const supportedAgentTypes: SupportedAgentType[] = [
  {
    id: "claude-code",
    name: "Claude Code",
    description: "Anthropic's Claude optimized for coding tasks with agentic capabilities",
    icons: [
      {
    ...
    modes: [
      { id: "code", name: "Code", description: "Focused on writing and editing code" },
      { id: "architect", name: "Architect", description: "High-level design and planning" },
      { id: "ask", name: "Ask", description: "Answer questions without making changes" },
    ],
    models: [
  ...
  },
  {
    id: "opencode",
    name: "OpenCode",
    description: "Open source AI coding agent supporting multiple LLM providers",
    icons: [
      {
    ...
    modes: [
      { id: "build", name: "Build", description: "Build and implement features" },
  ...
  },
  {
    ...
    modes: [
      ...
      { id: "architect", name: "Architect", description: "High-level design mode" },
    ],
    models: [
      { id: "claude-sonnet-4-20250514", name: "Claude Sonnet 4", provider: "Anthropic" },
      { id: "gpt-4o", name: "GPT-4o", provider: "OpenAI" },
  ...
  },
  {
    ...
    modes: [
      ...
      { id: "full-auto", name: "Full Auto", description: "Fully autonomous mode" },
    ],
    models: [
  ...
  },
  {
    ...
    modes: [
      { id: "suggest", name: "Suggest", description: "Get command suggestions" },
